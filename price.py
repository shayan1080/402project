...
c.execute(f'UPDATE Airpod SET price1= ?,price2=?,price3=? WHERE product_name = ?',(name,persian_to_english(Digikala),persian_to_english(Divar),persian_to_english(Technolife),))
conn.commit()
